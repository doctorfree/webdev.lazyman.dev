---
title: Webdev Menu Configuration
author: doctorfree
...
<h1 align="center">Webdev Menu Configuration</h1>

<div align="center">
<p float="left">
  <img
    src="https://raw.githubusercontent.com/wiki/doctorfree/nvim-lazyman/screenshots/webdev.png"
    alt="Webdev Configuration Menu"
...
## Webdev config script

The `webdev_config.sh` script is installed in `~/.config/nvim-Lazyman/scripts/`.

This script is used to display the `nvim-Webdev` configuration sub-menus in `lazyman`.
